const inputtextvalue = `
	<div class="row">
		{% if (typeof id !== 'undefined' && id == 'tableheader@oee') { %}
			...
			<div class="col-6 mb-1">
				<label>CheckboxSelection</label>
				<input name="checkboxSelection" type="text" value="{%=checkboxSelection%}" class="form-control"/>
			</div>
			<div class="col-6 mb-1">
				<label>HeaderCheckboxSelection</label>
				<input name="headerCheckboxSelection" type="text" value="{%=headerCheckboxSelection%}" class="form-control"/>
			</div>
		{% } else { %}
			<div class="col-6 mb-1">
				<label>Value</label>
