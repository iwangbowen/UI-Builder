...
const bootstrapcontainer = {
    ...
    html: `<div style="${defaultSizeStyle}" class="container-fluid ${dashedBorder} ${configurableComponent} ${draggableComponent} ${scaleOnResizeComponent} ${droppableComponent} ${resizableComponent}" ${dataComponentId}="${bootstrapcontainerid}"></div>`,
    sortable: false,
    droppable: true,
    getDropHtml() {
        return this.html;
