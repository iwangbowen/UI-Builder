...
import { multiSelectedClass, nonTemplateScriptType, removeableScript } from '../constants';
...
const removeableScriptSelector = `script[class=${removeableScript}]`;
