...
Vvveb.Builder = {
	...
	_initHightlight: function _initHightlight() {
		...
		var arrowKeyMove = function arrowKeyMove(key) {
			var dx = 0,
			    dy = 0;
			switch (key) {
				case 37:
			...
			var x = (parseFloat(self.selectedEl.attr('data-x')) || 0) + dx,
